            ...
            <View style={styles.finish_order}>
                <Image source={require('../assets/User.png')}></Image>
                    <View style={styles.finish_orderText}>
                        ...
                        <Text style={styles.finish_order_content}>Order Completed</Text>
                        <Text style={styles.finish_order_text}>Please rate your last Driver</Text>
                    </View>
                    ...
                    <View style={styles.submit_skip}>
                        <TouchableOpacity  style={styles.btn_submit}>
                            <Text style={styles.submit_text} onPress={() => navigation.navigate('Rate_Food')}>Submit</Text>
                        </TouchableOpacity>
