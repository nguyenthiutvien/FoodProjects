            ...
            <View style={styles.finish_order}>
                <Image source={require('../assets/Rate_restaurant.png')}></Image>
                    <View style={styles.finish_orderText}>
                        ...
                        <Text style={styles.finish_order_text}>Please rate your Restaurant</Text>
                    </View>
                    ...
                    <View style={styles.submit_skip}>
                        <TouchableOpacity  style={styles.btn_submit} onPress={() => navigation.navigate("Vourcher_Promo")}> 
...
export default Rate_Restaurant;