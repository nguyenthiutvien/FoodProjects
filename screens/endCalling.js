    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.ringing}>15.32 Min</Text>
            </View>
            <View style={styles.tools}>
                <Image style={styles.speaker} source={require('../assets/Mute_Icon.png')}></Image>
